...
# ACDS 17.0 602 win32 2022.02.18.19:00:04
# ----------------------------------------
...
# ----------------------------------------
# If scandubclk_pll is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "scandubclk_pll"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/scandubclk_pll.vo"
}
